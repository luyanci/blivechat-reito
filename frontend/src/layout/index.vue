<template>
  <el-container class="app-wrapper" :class="{ mobile: isMobile }">
    ...
    <el-aside width="230px" class="sidebar-container" :class="{ 'hide-sidebar': hideSidebar }">
      ...
      <div class="version">
        <a href="https://github.com/luyanci/blivechat-reito/releases" target="_blank">下载更新</a>
      </div>
      <div class="version">
        <a href="https://www.yuque.com/doodle-irifi/ueaigm/stntb3" target="_blank">版本记录</a>
      </div>
      <div class="version">
